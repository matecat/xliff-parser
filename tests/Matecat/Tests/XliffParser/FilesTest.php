...
class FilesTest extends Base
{
    ...
    {
        $pathInfo = Files::pathInfo($this->getTestFilePath('file-with-notes-converted-nobase64.xliff'));
    ...
    {
        $this->assertTrue(Files::isXliff($this->getTestFilePath('file-with-notes-converted-nobase64.xliff')));
        $this->assertFalse(Files::isXliff($this->getTestFilePath('note.xml')));
    }

    #[Test]
    public function pathInfo_returns_all_components_by_default()
    {
    ...
    #[Test]
    public function pathInfo_returns_only_dirname_when_requested()
    {
    ...
    #[Test]
    public function pathInfo_returns_only_basename_when_requested()
    {
        $path = '/path/to/my/file.txt';
    ...
    #[Test]
    public function pathInfo_returns_only_extension_when_requested()
    {
        $path = '/path/to/my/file.TXT';
    ...
    #[Test]
    public function pathInfo_returns_only_filename_when_requested()
    {
        $path = '/path/to/my/file.txt';
    ...
    #[Test]
    public function pathInfo_handles_multiple_dots_in_filename()
    {
    ...
    #[Test]
    public function pathInfo_handles_combined_flags()
    {
    ...
    #[Test]
    public function pathInfo_handles_uppercase_extensions()
    {
    ...
    #[Test]
    public function pathInfo_handles_utf8_characters()
    {
    ...
    #[Test]
    public function getExtension_returns_extension_in_lowercase()
    {
    ...
    #[Test]
    public function getExtension_returns_null_for_empty_pathinfo()
    {
    ...
    #[Test]
    public function getExtension_handles_multiple_dots()
    {
    ...
    #[Test]
    public function isXliff_returns_true_for_xliff_extension()
    {
    ...
    #[Test]
    public function isXliff_returns_true_for_sdlxliff_extension()
    {
    ...
    #[Test]
    public function isXliff_returns_true_for_tmx_extension()
    {
    ...
    #[Test]
    public function isXliff_returns_true_for_xlf_extension()
    {
    ...
    #[Test]
    public function isXliff_returns_false_for_non_xliff_extensions()
    {
    ...
    #[Test]
    public function isXliff_returns_false_when_no_extension()
    {
        $this->assertFalse(Files::isXliff('/path/to/filename'));
    }

    #[Test]
    public function getMemoryFileType_returns_tmx_for_tmx_files()
    {
    ...
    #[Test]
    public function getMemoryFileType_returns_false_for_non_tmx_files()
    {
    ...
    #[Test]
    public function getMemoryFileType_returns_false_for_empty_path()
    {
        $this->assertFalse(Files::getMemoryFileType(''));
    }

    #[Test]
    public function isTMXFile_returns_true_for_tmx_files()
    {
    ...
    #[Test]
    public function isTMXFile_returns_false_for_non_tmx_files()
    {
    ...
    #[Test]
    public function isGlossaryFile_always_returns_false()
    {
    ...
    #[Test]
    public function pathInfo_handles_windows_paths()
    {
    ...
    #[Test]
    public function pathInfo_handles_file_without_extension()
    {
    ...
    #[Test]
    public function pathInfo_handles_single_filename()
    {
        $path = 'file.txt';
        $pathInfo = Files::pathInfo($path);
    ...
    #[Test]
    public function pathInfo_handles_hidden_files()
    {
        $path = '/path/to/.hidden';
        $pathInfo = Files::pathInfo($path);
    ...
    #[Test]
    public function pathInfo_returns_single_value_when_one_flag()
    {
        $path = '/path/to/file.txt';
    ...
    #[Test]
    public function getExtension_handles_edge_cases()
    {
    ...
    #[Test]
    public function all_methods_work_together()
    {
