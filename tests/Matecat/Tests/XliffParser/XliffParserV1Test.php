...
class XliffParserV1Test extends Base
{
    ...
    public function can_parse_xliff_v1_tu_with_extenal_tags_in_seg_source_and_target(): void
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-notes-converted-and-seg-source-with-ex-tags.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-self-closed-tag-and-alt-trans.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-empty-self-closed-target-tag-with-alt-trans.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-empty-target-tag-withnot-ordered-alt-trans.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-not-empty-target-tag-without-alt-trans.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-not-empty-target-tag-with-mrk-with-alt-trans.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-not-empty-target-tag-with-some-mrk-with-alt-trans.xliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('file-with-not-empty-target-tag-with-some-mrk-and-html-with-alt-trans.xliff')
        );
    ...
    public function can_parse_a_very_large_xliff_v12(): void
    {
        ...
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('ENIMAC_XT CARTESIAN 3_REV.1.0_ITA.docx (7).sdlxliff')
        );
    ...
    {
        $parsed = (new XliffParser())->xliffToArray(
            $this->getTestFile('nested-tag-group/context-group-trans-unit.jsont2.xlf')
        );
